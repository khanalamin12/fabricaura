...
// Initial render on page load — wrapped in DOMContentLoaded so the grid element exists
document.addEventListener('DOMContentLoaded', function() {
...
function toggleWish(e, id) {
  ...
  updateWishBadge();
  renderSections();
  // If wishlist drawer is open, re-render it instantly so removal shows immediately
